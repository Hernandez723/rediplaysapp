...
class App :
    ...
    override fun onCreate() {
        ...
        // AdMob is initialized lazily — only when the user explicitly requests to view an ad
        // (via the "Support Rediplays" button). This prevents the advertising SDK from
        // collecting device data on every launch without user interaction.
        // See RewardedAdManager.loadRewardedAd() which initializes MobileAds on first call.
