...
object PlayerSliderColors {
    ...
    fun getSliderColors(
        ...
        val finalActiveColor = if (useDarkTheme) Color.White else activeColor
        ...
        return SliderDefaults.colors(
            ...
            activeTickColor = finalActiveColor,
            thumbColor = finalActiveColor,
            inactiveTrackColor = inactiveTrackColor,
            disabledActiveTrackColor = finalActiveColor,
            disabledInactiveTrackColor = inactiveTrackColor,
            disabledThumbColor = finalActiveColor
        )
    }
}
