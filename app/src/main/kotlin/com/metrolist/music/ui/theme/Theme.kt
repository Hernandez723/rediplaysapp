...
/**
 * Elegant dark background with subtle ambient corner gradients
 */
fun Modifier.darkCornerGradients(): Modifier = this.drawBehind {
    drawRect(Color(0xFF060709))
    
    drawCircle(
        brush = Brush.radialGradient(
            colors = listOf(Color(0x244F46E5), Color.Transparent),
            center = Offset(0f, 0f),
    ...
    drawCircle(
        brush = Brush.radialGradient(
            colors = listOf(Color(0x2010B981), Color.Transparent),
