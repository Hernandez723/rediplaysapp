...
fun OnlineSearchResult(
    ...
    Column(
        ...
        // Google-style SearchBar with Neon Purple Material 3 design
        OutlinedTextField(
            value = query,
            ...
            placeholder = {
                Text(
                    text = stringResource(R.string.search_rediplays),
            ...
            colors =
                OutlinedTextFieldDefaults.colors(
                    ...
                    unfocusedBorderColor = Color(0xFFA855F7).copy(alpha = 0.6f),
