...
object Shazam {
    ...
    private val client by lazy {
        HttpClient(OkHttp) {
            ...
            engine {
                // OkHttp integrates with Android's native SSL stack, which correctly
                // handles domain-specific network_security_config.xml rules and calls
                // the 3-argument checkServerTrusted(X509Certificate[], String, String)
                // required when domain-config entries are present.
                config {
